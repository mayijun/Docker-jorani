...
RUN apt-get update -y && apt-get install -y php5.6 libapache2-mod-php5.6 php5.6-xml php5.6-zip php5.6-mbstring php5.6-ldap php5.6-mysql php5.6-mcrypt && rm -rf /var/lib/apt/lists/*
RUN phpenmod mcrypt
